...
# add plots for jaccard dissimilarity, move all plotting to a new script for simplicity
...
foliage_env_plots <- ggarrange(
  ...
  ncol = 2) %>% 
  annotate_figure(
    top = text_grob('Environmental Predictors of Differences in Foliage Arthropod Community Composition', size = 18))

# ggsave(
#   filename = 'figures/foliage_dissimilarity_env_plots.png',
...
foliage_dist_plots <- ggarrange(
  ...
  ncol = 2) %>% 
  annotate_figure(
    top = text_grob('Foliage Arthropod Community Composition Differences versus Geographic Distance'))

# ggsave(
#   filename = 'figures/foliage_dissimilarity_dist_plots.png',
